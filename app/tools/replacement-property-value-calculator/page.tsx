        ...
        <section className="border-t border-gray-200 py-12 md:py-16">
          <div className="mx-auto max-w-4xl px-6 md:px-8">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/tools/debt-relief-calculator" className="text-black underline underline-offset-4 hover:text-gray-800">
                  Debt Relief Calculator
                </Link>
              </li>
              <li>
                <Link href="/services/replacement-property-sourcing" className="text-black underline underline-offset-4 hover:text-gray-800">
