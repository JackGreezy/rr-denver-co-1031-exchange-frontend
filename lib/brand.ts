import { BRAND_NAME, PRIMARY_CITY, PRIMARY_STATE_ABBR, PRIMARY_PHONE_DISPLAY, PRIMARY_PHONE_DIGITS, PRIMARY_EMAIL, OFFICE_ADDRESS, PRIMARY_DOMAIN } from '@/lib/constants';
